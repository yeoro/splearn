...
//    }
    ...
    void invalidEmail() {
        assertThatThrownBy(() ->
                Member.create(new MemberCreateRequest("invalid email", "yeoro", "secret"), passwordEncoder)
        ).isInstanceOf(IllegalArgumentException.class);

        Member.create(new MemberCreateRequest("dufgh1009@gmail.com", "yeoro", "secret"), passwordEncoder);
    }
}